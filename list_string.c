 ...
 * Return: size of list
 */
list_t *node_add_end(list_t **head, const char *str, int num)
{
...
/**
 * node_at_index_delete - deletes node at given index
 * @head: address of pointer to first node
 * @index: index of node to delete
 *
 * Return: 1 on success, 0 on failure
 */
int node_at_index_delete(list_t **head, unsigned int index)
{
